...
<head>
	...
	<meta name="google-signin-client-id" content="800569414412-0b1ubuj79qkqlaph2isj3nqqf267fnb3.apps.googleusercontent.com">
...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<nav id="nav">
			...
			<?php
				if($login_button == ''){	
					echo '<a href="download.php"><span>Download</span></a>';						
				...
				<div class="spotlight">
					<div class="content">
						...
						<ul class="actions">
							...
							<?php
   								if($login_button == ''){							
									echo '<a href="download.php" class="button">Download</a>';
								}
								else {
									echo $login_button;
								}
